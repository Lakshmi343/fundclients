        ...
        <Grid>
          <Grid.Col lg={4}>
            <Stack spacing="xs" justify="center" sx={{ height: "100%" }}>
              ...
              <Title order={3}>Fund Harbour Gives You More</Title>
              <Text>
                Supercharge your fundraising efforts with our unique tools,
                features and personal support. Helping you raise more money than
                you could elsewhere!
              </Text>
            </Stack>
          </Grid.Col>
