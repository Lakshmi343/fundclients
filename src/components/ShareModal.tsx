      ...
      <Stack>
        ...
        <Paper>
          <Flex wrap="wrap" gap="xs">
            <Button
              leftIcon={<IconBrandFacebook size={iconSize} />}
              {...buttonProps}
            >
              Facebook
            </Button>
            <Button
              leftIcon={<IconBrandTwitter size={iconSize} />}
              {...buttonProps}
            >
              Twitter
            </Button>
            <Button
              leftIcon={<IconBrandInstagram size={iconSize} />}
              {...buttonProps}
            >
              Instagram
            </Button>
            <Button
              leftIcon={<IconBrandLinkedin size={iconSize} />}
              {...buttonProps}
            >
              LinkedIn
            </Button>
        ...
        <Paper>
          <Flex align="flex-end" gap="sm">
            <TextInput
              label="Copy Link"
              value={`https://Fund Harbour.com/${campaign?.id}`}
              disabled
              sx={{ flex: "1 1 auto" }}
            />
            <CopyButton
