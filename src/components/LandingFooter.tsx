  ...
  return (
    <footer className={classes.footer}>
      <Container className={classes.inner} size="lg">
        <div className={classes.logo}>
          <Stack align="flex-start">
            <BrandName size={40} />
            <Text size="sm">
              Fund Harbour is a crowdfunding website that lets you raise money
              for anything that matters to you. From personal causes and events
              to projects and more. We've helped people from all over the world
              raise millions online.
            </Text>
          </Stack>
        </div>
      ...
      <Container className={classes.afterFooter} size="lg">
        <Text size="sm">
          © {new Date().getFullYear()} Fund Harbour. All rights reserved.
        </Text>
