                                        ...
                                        <Stack mt="md">
                                            ...
                                            {!matchesMobile ?
                                                <Flex gap="xs" align="center">
                                                    ...
                                                    <UnstyledButton component={Anchor}>
                                                        <Flex gap="xs" align="center">
                                                            <Avatar src={campaign?.creator?.image} radius="xl" size="sm"/>
                                                ...
                                                <Stack>
                                                    <Flex gap="md">
                                                        ...
                                                        <UnstyledButton component={Anchor}>
                                                            <Flex gap="xs" align="center">
                                                                <Avatar src={campaign?.creator?.image} radius="xl"
                                                                        size="sm"/>
                                                                <Text size="sm">{campaign?.creator?.name}</Text>
                                                            </Flex>
                                                        </UnstyledButton>
                                            ...
                                            {matchesMobile && <>
                                                ...
                                                <Flex align="flex-end" gap="sm">
                                                    ...
                                                    <Text fw={500} align="center" color="dimmed">raised of {campaign?.fundingGoal}</Text>
                                                </Flex>
                                    ...
                                    <Paper {...paperProps}>
                                        ...
                                        <Accordion defaultValue="customization" variant="separated">
                                            <Accordion.Item value="customization">
                                                <Accordion.Control>When will {campaign?.creator?.name} get my payment?</Accordion.Control>
                                                <Accordion.Panel>Your payment is sent directly to {campaign?.creator?.name} so it immediately helps their campaign.</Accordion.Panel>
                                            </Accordion.Item>
